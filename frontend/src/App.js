...
import PetDetails from './components/PetDetails'; // Correct import for PetDetails
    ...
    <Router>
      <div className="App">
        <Routes>
          ...
          <Route path="/adopt" element={<ProtectedRoute user={user}><Adopt user={user} onLogout={handleLogout} /></ProtectedRoute>} />
